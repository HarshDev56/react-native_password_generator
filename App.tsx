...
const PasswordCheck = object({
  passwordLength: number()
    .min(4, 'Should be 4 charater minimum')
    .max(16, 'maximum it will allow till 16 character')
    .required("this is mandatory field you need to fill it ")
})
...
export default function App() {
  ...
  const generatePasswordString = (passwordLength: number) => {
    ...
    if (symbols) {
      characterlist = characterlist + speacialChars;
    }
  ...
  return (
    ...
    <SafeAreaView style={styles.appContainer}>
     ...
     validationSchema={PasswordCheck}
     onSubmit={ values => {
